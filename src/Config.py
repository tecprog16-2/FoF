...
class Config:
  ...
  def set(self, section, option, value):
    ...
    if type(value) == unicode:
      ...
      value = str(value)
      assert type(value) is str, "The value of the option must be a string"
      assert len(value) > 0, "An error occurred while converting the string. There is no string with the size smaller than zero."
